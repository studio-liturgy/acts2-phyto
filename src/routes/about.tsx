...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: isTest ? "https://phytoexp.live/about" : "https://phyto.live/about" },
    ],
    links: [
      { rel: "canonical", href: isTest ? "https://phytoexp.live/about" : "https://phyto.live/about" },
