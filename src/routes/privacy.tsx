      ...
      <main className="mx-auto w-full max-w-3xl flex-1 px-6 py-16">
        ...
        <div className="mt-8 space-y-6 text-base leading-relaxed opacity-90">
          ...
          <section>
            ...
            <p className="mt-2">Phyto does not use authentication cookies.</p>
            <p className="mt-2">Phyto uses the following strictly-necessary functional cookies required for the App to function:</p>
            <ul className="mt-2 list-disc space-y-1 pl-6">
