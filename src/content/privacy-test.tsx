      ...
      <Tabs defaultValue={defaultSection} className="mt-3">
        ...
        <TabsContent value="offline">
          <div className="mt-6 space-y-6 text-base leading-relaxed opacity-90">
            <p>
              This policy applies when you use phytoexp locally on your device without creating an
              account. phytoexp is an experimental testing environment. Data here may be reset at
              any time.
            </p>
            ...
            <section>
              ...
              <p className="mt-2">
                phytoexp is fully usable without creating an account or providing any personal
            ...
            <section>
              ...
              <p className="mt-2">
                All content you create in phytoexp is stored exclusively on your own device using
                your browser's local storage and IndexedDB. This data:
              </p>
            ...
            <section>
              ...
              <p className="mt-2">
                ...
                <a href="https://phytoexp.live/feedback" className="underline hover:opacity-60">
            ...
            <section>
              ...
              <p className="mt-2">
                phytoexp includes an optional contribute form at{" "}
                <a href="https://phytoexp.live/contribute" className="underline hover:opacity-60">
            ...
            <section>
              ...
              <p className="mt-2">
                phytoexp does not use tracking pixels, analytics services, or any monitoring
            ...
            <section>
              ...
              <p className="mt-2">
                phytoexp is served via Cloudflare Workers. Cloudflare may collect standard
                server-side logs such as IP addresses as part of normal hosting operations. Please
                review{" "}
                <a
        ...
        <TabsContent value="online">
          <div className="mt-6 space-y-6 text-base leading-relaxed opacity-90">
            <p>
              This policy applies when you create an account and use phytoexp's online features,
            ...
            <section>
              ...
              <p className="mt-2">
                ...
                are stored in Cloudflare R2 (object storage) rather than on your device. Each
                account can store up to 300 MB of video.
              </p>
              <p className="mt-2">
            ...
            <section>
              ...
              <p className="mt-2">
                phytoexp uses the following third-party services for online features:
              </p>
              <ul className="mt-2 list-disc space-y-1 pl-6">
                <li>
            ...
            <section>
              <h2 className="text-2xl">10. Children's Privacy</h2>
              <p className="mt-2">
                phytoexp's online features are not directed at children under 13. We do not
                knowingly collect personal information from children. If you believe a child has
                created an account, please contact us via the feedback form and we will delete it
                promptly.
              </p>
            </section>
