          ...
          <TabsContent value="online">
            <div className="mt-6 space-y-6 text-base leading-relaxed opacity-90">
              ...
              <section>
                ...
                <p className="mt-2">Your data is retained for as long as your account exists. To request deletion of your account and all associated data from Supabase, contact us via the feedback form at <Link to="/feedback" className="underline hover:opacity-60">phytoexp.live/feedback</Link>. We will process deletion requests within 30 days. Account deletion also removes any video media you uploaded to Cloudflare R2. If you opted in to the mailing list, you can unsubscribe at any time using the link in any email. Local data on your device must be cleared separately by clearing your browser's IndexedDB storage.</p>
              </section>
