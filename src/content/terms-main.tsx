      ...
      <Tabs defaultValue={defaultSection} className="mt-3">
        ...
        <TabsContent value="offline">
          <div className="mt-6 space-y-6 text-base leading-relaxed opacity-90">
            <p>
              These terms apply to all users of phyto, whether or not you create an account. Please
            ...
            <section>
              ...
              <p className="mt-2">
                phyto (
                <a href="https://phyto.live" className="underline hover:opacity-60">
                  phyto.live
                </a>
                ) is a free, open-source stage presenter application for projecting song lyrics,
                Bible verses, and custom images during live worship gatherings and presentations. It
                is available for use online and as an installable offline application. An optional
                account enables cross-device sync and live sharing features.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mt-2">
                phyto is, and will always remain, free to use. There is no fee, subscription,
            ...
            <section>
              ...
              <p className="mt-2">
                phyto is a presentation tool only. It does not license, distribute, or authorise the
                public performance, reproduction, or display of copyrighted musical works.
              </p>
              <p className="mt-2">
                If you use phyto to display song lyrics or other copyrighted content in a public or
                congregational setting, you are solely responsible for obtaining the appropriate
        ...
        <TabsContent value="online">
          <div className="mt-6 space-y-6 text-base leading-relaxed opacity-90">
            <p>
              These additional terms apply when you create an account and use phyto's online
