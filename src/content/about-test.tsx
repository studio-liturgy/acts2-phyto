      ...
      >
        <div className="mx-auto w-full max-w-6xl px-6 pt-10 pb-24 md:pt-14 md:pb-32">
          ...
          <div className="mt-10 max-w-5xl space-y-10 text-3xl md:text-[2.6rem] md:leading-[1.15] leading-snug">
            <p>
              phytoexp is an experimental open testing environment for phyto. Feel free to test upcoming features on this site and give feedback if you encounter any bugs. Access a more stable version of phyto below.
            </p>
          </div>
